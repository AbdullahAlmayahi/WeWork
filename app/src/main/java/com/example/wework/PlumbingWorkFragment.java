...
public class PlumbingWorkFragment extends Fragment implements AdvertisementAdapter.AdvertisementClickInterface{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_plumbing_work, container, false);
    ...
    private void getAllAdvertisement(){
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (SectionData.getSectionAdvs().equals("Plumbing Work")){
